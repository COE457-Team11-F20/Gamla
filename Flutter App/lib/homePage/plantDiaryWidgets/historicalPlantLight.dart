...
class HistoricalPlantLightView extends StatefulWidget {
  final AnimationController animationController;
  final Animation animation;
  final MQTTClientWrapper client;

  const HistoricalPlantLightView(
      {Key key, this.animationController, this.animation, this.client})
      : super(key: key);

  @override
  _HistoricalPlantLightView createState() =>
      _HistoricalPlantLightView(animationController, animation, client);
}

class _HistoricalPlantLightView extends State<HistoricalPlantLightView> {
  ...
  _HistoricalPlantLightView(AnimationController animationControlleraa,
  ...
  Widget build(BuildContext context) {
    client.updates.listen((List<MqttReceivedMessage<MqttMessage>> c) {
      c.forEach((element) {
        if (element.topic == "plantLightsChart") {
