...
class HistoricalPlantTempView extends StatefulWidget {
  final AnimationController animationController;
  final Animation animation;
  final MQTTClientWrapper client;

  const HistoricalPlantTempView(
      {Key key, this.animationController, this.animation, this.client})
      : super(key: key);

  @override
  _HistoricalPlantTempView createState() =>
      _HistoricalPlantTempView(animationController, animation, client);
}

class _HistoricalPlantTempView extends State<HistoricalPlantTempView> {
  ...
  _HistoricalPlantTempView(AnimationController animationControlleraa,
  ...
  Widget build(BuildContext context) {
    client.updates.listen((List<MqttReceivedMessage<MqttMessage>> c) {
      c.forEach((element) {
        if (element.topic == "plantTempsChart") {
